...
public abstract class SpiderBase
{
    ...
    {
       // System.out.println("readPageByGet 构造函数");
        ...
        while( n> 0)
        {
            try{
                ...
                if(httpClient.executeMethod(method) != HttpStatus.SC_OK)
                {
                    ...
                    n--;
                   // System.out.println("method执行不成功");
                }else
                {
                    responseHeaders = method.getRequestHeaders();
                  //  System.out.println("请求头部信息为"+responseHeaders.toString());
    ...
    public String getPageSourceCode() {
        //System.out.println("网页源码:"+pageSourceCode);
